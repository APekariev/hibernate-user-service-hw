...
public class Main {
    ...
    private static final String FAST_AND_FURIOUS_MOVIE = "Fast and Furious";
    private static final String USER_EMAIL = "abc@gmail.com";
    private static final String USER_PASSWORD = "def";
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        Movie fastAndFurious = new Movie(FAST_AND_FURIOUS_MOVIE);
